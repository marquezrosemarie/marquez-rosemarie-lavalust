...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; } body { margin:0; min-height:100vh; padding:28px 18px; font-family:Georgia,'Times New Roman',serif; color:var(--ink); background:linear-gradient(135deg,#ead6dc,#d8c1c8 52%,#eee0d2); }
        ...
        .profile { align-self:center; } .avatar { width:92px; height:92px; margin-bottom:18px; display:grid; place-items:center; border-radius:18px; color:#fff; font-size:2.2rem; font-weight:700; background:var(--accent-dark); box-shadow:9px 9px 0 #9b405355; } h2 { margin:0 0 20px; overflow-wrap:anywhere; }
