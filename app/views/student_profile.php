...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; } body { margin:0; min-height:100vh; padding:28px 18px; font-family:Georgia,'Times New Roman',serif; color:var(--ink); background:linear-gradient(135deg,#ead6dc,#d8c1c8 52%,#eee0d2); } .shell { width:min(1100px,100%); margin:auto; }
        ...
        .avatar { width:112px; height:112px; margin-bottom:18px; display:grid; place-items:center; border-radius:18px; color:#fff; font-size:2.5rem; font-weight:700; background:var(--accent-dark); box-shadow:9px 9px 0 #9b405355; } .profile-title { margin-bottom:12px; font-size:1.45rem; font-weight:700; overflow-wrap:anywhere; } .badge { display:inline-block; padding:7px 10px; border-left:3px solid var(--accent); color:var(--accent-dark); background:#ffffff55; font-size:.73rem; font-weight:700; text-transform:uppercase; }
